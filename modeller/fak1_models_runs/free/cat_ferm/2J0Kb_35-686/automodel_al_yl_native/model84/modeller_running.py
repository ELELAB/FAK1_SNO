...
class MyModel(automodel):
   ...
   def user_after_single_model(self):
       self.rename_segments(segment_ids=('B'), renumber_residues=[35])
...
a = MyModel(env,
           ...
           knowns   = '2j0kB_model84_al',               # codes of the templates
           sequence = 'FAK1_2j0kB_yl_84')               # code of the target -> same name of the alignment file
