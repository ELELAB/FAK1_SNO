...
class MyModel(automodel):
   ...
   #define the atoms to be moved during the modelling/optimization, in our case select residues from 506 to 527 from the model numbering
   def select_atoms(self):
       return selection(self.residue_range('505:', '528:'))

#use the subclass defined before
a = MyModel(env,
           alnfile  = 'alignment.ali',      # alignment filename
           knowns   = '2j0j_final_tot_clean_retromut',               # codes of the templates
           sequence = 'hFAK1_2j0j_al')               # code of the target -> same name of the alignment file
            
a.starting_model= 1                 # index of the first model
a.ending_model  = 5              # index of the last model - for testing set to 2
